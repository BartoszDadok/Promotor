    ...
    return (
        <FooterWrapper>
            <FooterContainer>
                ...
                <PageParagraph margin={ "0.3em 0 0.1em 0" } color={ "white" }>Zadzwoń: <StyledLink href="tel:+48618676623">+48 61
                    867
                ...
                <GridWrapper>
                    ...
                    <Informations>
                        ...
                        <PageParagraph color={ "white" }><StyledLink href="mailto: biuro@promotor.pl">biuro@promotor.pl</StyledLink></PageParagraph>
                    </Informations>
                    <Informations>
                        <PageParagraph fontWeight={ "700" } margin={ "0.3em 0" }
