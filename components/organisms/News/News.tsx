    ...
    return (
        <>
            <NewsContainer>
                ...
                <ol>
                    <li>
                        <PageParagraph fontSize={ "1.1rem" } margin={ "0.4em 0" }>Zarezerwuj wycieczkę w naszym biurze,
                            a
                    ...
                    <li>
                        <PageParagraph fontSize={ "1.1rem" } margin={ "0.4em 0" }>Zamawiasz wyjazd i sprzęt narciarski
                            za
                    ...
                    <li>
                        <PageParagraph fontSize={ "1.1rem" } margin={ "0.4em 0" }>Czas w naszym biurze spędzisz w miłej
