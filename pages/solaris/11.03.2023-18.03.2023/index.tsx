                    ...
                    <LeftSideWrapper>
                        ...
                        <DetailsWrapper>
                            ...
                            <PricingWrapper>
                                ...
                                <List>
                                    <ListItem><PageParagraph margin={ "0 0 0.1em 0" } color={ "white" }>dorośli - 3399
                            ...
                            <PricingWrapper>
                                ...
                                <List>
                                    <ListItem><PageParagraph margin={ "0 0 0.1em 0" } color={ "white" }>dorośli - 3749
                                        zł</PageParagraph></ListItem>
                                    <ListItem>
                                        <PageParagraph margin={ "0 0 0.1em 0" } color={ "white" }>dzieci 0-7
                                            lat - 2969
