...
const Index = () => {
    const date = ["18.03.2023 - 25.03.2023", "17.03.2023 - 26.03.2023"];
            ...
            <PageWrapper>
                ...
                <ContentWrapper>
                    ...
                    <LeftSideWrapper>
                        ...
                        <Line/>
                        <DetailsWrapper>
                            <PageParagraph margin={ "0 0 0.6em 0" } fontWeight={"700"} color={ "white" }><u>Wycieczka tylko dla grup zorganizowanych</u></PageParagraph>
                            ...
                            <PricingWrapper>
                                ...
                                <List>
                                    <ListItem><PageParagraph margin={ "0 0 0.1em 0" } color={ "white" }>dorośli - 3248
                            ...
                            <PricingWrapper>
                                ...
                                <List>
                                    <ListItem><PageParagraph margin={ "0 0 0.1em 0" } color={ "white" }>dorośli - 3598
                                        zł</PageParagraph></ListItem>
                                    <ListItem>
                                        <PageParagraph margin={ "0 0 0.1em 0" } color={ "white" }>dzieci 0-7
                                            lat - 2818
