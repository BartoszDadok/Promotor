...
const Index = () => {
    const date = ["10.12.2022 - 18.12.2022", "09.12.2022 - 18.12.2022"];
                ...
                <ContentWrapper>
                            ...
                            <List>
                                ...
                                <ListItem>
                                    <PageParagraph margin={ "0.2em 0 0 0" } color={ "white" }>
                                        Rozszerzenie 6 dniowego skipassu do Trzech Dolin (ok. 600 km) - 55 Euro/os
                                    </PageParagraph>
                                </ListItem>
                            </List>
                            ...
                            <List>
                                <ListItem>
                                    <PageParagraph margin={ "0 0 0.1em 0" } color={ "white" }> 1 niewykorzystane miejsce
                                        w apartamencie - 490 PLN</PageParagraph>
                                </ListItem>
                                <ListItem>
                    ...
                    <RightSideWrapper>
                        ...
                        <ListDescribe margin={ "0 0 1em 0" }>
                            ...
                            <ListItem><PageParagraph>dopłaty za niewykorzystane miejsce w apartamencie – 490
