...
const Index = () => {
    const date = ["04.02.2023 - 11.02.2023", "03.02.2023 - 12.02.2023"];
                ...
                <ContentWrapper>
                    ...
                    <LeftSideWrapper>
                        ...
                        <DetailsWrapper>
                            ...
                            <PageParagraph margin={ "0 0 0.6em 0" } color={ "white" }><b>Termin wyjazdu z dojazdem
                                autokarem: </b>
                                03.02.2023 - 12.02.2023</PageParagraph>
                            ...
                            <PricingWrapper>
                                ...
                                <List>
                                    <ListItem><PageParagraph margin={ "0 0 0.1em 0" } color={ "white" }>dorośli - 2449
                            ...
                            <PricingWrapper>
                                ...
                                <List>
                                    <ListItem><PageParagraph margin={ "0 0 0.1em 0" } color={ "white" }>dorośli - 2874
                                        zł</PageParagraph></ListItem>
                                    <ListItem><PageParagraph margin={ "0 0 0.1em 0" } color={ "white" }>dzieci 0-7
                                        lat -
                                        505
